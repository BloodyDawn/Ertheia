 ...
 * @author L0ngh0rn
 */
public class ConfigFloodProtector extends Config
{
	private static final String path = FLOOD_PROTECTOR_CONFIG;
	...
	public static void loadConfig()
	{
		...
		try
		{
			...
			FLOOD_PROTECTOR_COMMUNITY_BOARD = new FloodProtectorConfig("CommunityBoardFloodProtector");
			FLOOD_PROTECTOR_CLAN_SEARCH = new FloodProtectorConfig("ClanSearchFloodProtector");
			loadFloodProtectorConfigs(properties);
		}
		catch(Exception e)
		{
