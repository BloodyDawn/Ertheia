...
import dwo.gameserver.model.world.residence.clanhall.ClanHallFlagWar;
 ...
 * @author BiggBoss
 */
public class WildBeastReserve extends ClanHallFlagWar
{
	static
	{
		qn = "WildBeastReserve";
	...
	{
		new WildBeastReserve(-1, qn, "conquerablehalls", BEAST_FARM);
	}
