...
public class GiftOfVitality extends Quest
{
	...
	private static final int[][] _spawns = {
		{82766, 149438, -3464, 33865}, {82286, 53291, -1488, 15250}, {147060, 25943, -2008, 18774},
		{148096, -55466, -2728, 40541}, {87116, -141332, -1336, 52193}, {43521, -47542, -792, 31655},
		{17203, 144949, -3024, 18166}, {111164, 221062, -3544, 2714}, {-13869, 122063, -2984, 18270},
		{-83161, 150915, -3120, 17311}, {45402, 48355, -3056, 49153}, {115616, -177941, -896, 30708},
		{-44928, -113608, -192, 30212}, {-84037, 243194, -3728, 8992}, {-119690, 44583, 360, 29289},
	...
	{
		if(ConfigEvents.EVENT_GIFT_OF_VITALITY_ENABLE)
		{
			_log.log(Level.INFO, "[EVENTS] : Gift of Vitality Event Enabled");
			new GiftOfVitality();
		}
	}
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		else if(event.equalsIgnoreCase("memories_summon"))
		{
			...
			else if(player.getPets().isEmpty())
			{
