...
public class _00128_PailakaSongofIceandFire extends Quest
{
	...
	private static final int[] ITEMS = {
		SWORD, ENH_SWORD1, ENH_SWORD2, BOOK1, BOOK2, BOOK3, BOOK4, BOOK5, BOOK6, BOOK7, WATER_ESSENCE, FIRE_ESSENCE,
		SHIELD_POTION, HEAL_POTION, FIRE_ENHANCER, WATER_ENHANCER
	};

	private static final int[][] DROPLIST = {
		// must be sorted by npcId !
		// npcId, itemId, chance
		{BLOOM, SHIELD_POTION, 30}, {BLOOM, HEAL_POTION, 80}, {BOTTLE, SHIELD_POTION, 10}, {BOTTLE, WATER_ENHANCER, 40},
		{BOTTLE, HEAL_POTION, 80}, {BRAZIER, SHIELD_POTION, 10}, {BRAZIER, FIRE_ENHANCER, 40},
	...
	public _00128_PailakaSongofIceandFire()
	{
		addStartNpc(ADLER1);
		addTalkId(ADLER1);
		addFirstTalkId(NPCS);
	...
	{
		new _00128_PailakaSongofIceandFire();
	}
	...
	private void enterInstance(L2PcInstance player)
	{
		synchronized(this)
		{
			...
			if(world != null)
			{
				if(world.templateId != InstanceZoneId.PAILAKA_FORGOTTEN_TEMPLE.getId())
				{
			...
			{
				int instanceId = InstanceManager.getInstance().createDynamicInstance("Pailaka_SongOfIceAndFire.xml");

				world = new InstanceWorld();
				world.instanceId = instanceId;
				world.templateId = InstanceZoneId.PAILAKA_FORGOTTEN_TEMPLE.getId();
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		switch(npc.getNpcId())
		{
			case ADLER1:
				switch(st.getState())
				{
					case CREATED:
						...
						return "32497-01.htm";
					case STARTED:
						return cond > 1 ? "32497-00.htm" : "32497-03.htm";
					case COMPLETED:
						return "32497-07.htm";
					default:
						return "32497-01.htm";
			...
			case SINAI:
				return cond > 1 ? "32500-00.htm" : "32500-01.htm";
			case INSPECTOR:
				switch(cond)
				{
					case 1:
	...
	public String onExitZone(L2Character character, L2ZoneType zone)
	{
		if(character instanceof L2PcInstance && !character.isDead() && !character.isTeleporting() && ((L2PcInstance) character).isOnline())
		{
			...
			if(world != null && world.templateId == InstanceZoneId.PAILAKA_FORGOTTEN_TEMPLE.getId())
			{
