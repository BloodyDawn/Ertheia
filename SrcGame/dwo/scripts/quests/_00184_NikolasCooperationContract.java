...
public class _00184_NikolasCooperationContract extends Quest
{
	// Квестовые персонажи
	...
	public _00184_NikolasCooperationContract()
	{
	...
	{
		new _00184_NikolasCooperationContract();
	}
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		if(event.equals("quest_accept") && !st.isCompleted())
		{
			if(st.getPlayer().getLevel() >= 40)
			{
				...
				return "maestro_nikola_q0184_06.htm";
			}
			else
			{
				return "maestro_nikola_q0184_03a.htm";
			}
		}
		if(event.equals("1"))
		{
	...
	public String onAsk(L2PcInstance player, L2Npc npc, QuestState st, int reply)
	{
		...
		if(npcId == Nikola)
		{
			switch(reply)
			{
				case 1:
					...
					return "maestro_nikola_q0184_03.htm";
				case 2:
					return "maestro_nikola_q0184_04.htm";
				case 3:
					return "maestro_nikola_q0184_05.htm";
			}
		}
		else if(npcId == Lorain)
		{
			...
			{
				case 1:
					return "researcher_lorain_q0184_02.htm";
				case 2:
					st.playSound(QuestSound.ITEMSOUND_QUEST_MIDDLE);
					st.setCond(2);
					st.takeItems(NicolasMap, -1);
					return "researcher_lorain_q0184_03.htm";
				case 3:
					st.playSound(QuestSound.ITEMSOUND_QUEST_MIDDLE);
					st.setCond(3);
					return "researcher_lorain_q0184_05.htm";
				case 4:
					return "researcher_lorain_q0184_08.htm";
				case 5:
					String htmltext = "researcher_lorain_q0184_09.htm";
		...
		else if(npcId == Device)
		{
			switch(reply)
			{
				case 1:
					...
					return "broken_controller_q0184_02.htm";
				case 2:
					st.unset("step");
					st.playSound(QuestSound.ITEMSOUND_QUEST_MIDDLE);
					st.setCond(4);
					st.giveItems(Metal, 1);
					return "broken_controller_q0184_06.htm";
				case 3:
					st.unset("step");
					st.playSound(QuestSound.ITEMSOUND_QUEST_MIDDLE);
					st.setCond(5);
					st.giveItems(BrokenMetal, 1);
					return "broken_controller_q0184_08.htm";
			}
		}
		else if(npcId == Alarm)
		{
			...
			switch(reply)
			{
				case 2:
					st.set("pass", "0");
					return "alarm_of_giant_q0184_q0184_02.htm";
				case 3:
					st.set("pass", String.valueOf(++pass));
					return "alarm_of_giant_q0184_q0184_03.htm";
				case 4:
					st.set("pass", String.valueOf(++pass));
					return "alarm_of_giant_q0184_q0184_05.htm";
				case 5:
					st.set("pass", String.valueOf(++pass));
					return "alarm_of_giant_q0184_q0184_07.htm";
				case 6:
					if(pass == 4)
					{
						st.set("step", "3");
						...
						st.unset("pass");
						npc.getLocationController().delete();
						return "alarm_of_giant_q0184_q0184_09.htm";
					}
					else
					{
						return "alarm_of_giant_q0184_q0184_10.htm";
					}
			}
		}
		return null;
	...
	public String onTalk(L2Npc npc, QuestState st)
	{
		...
		if(npcId == Nikola)
		{
			...
			{
				case CREATED:
					return st.getPlayer().getLevel() < 40 ? "maestro_nikola_q0184_03a.htm" : "maestro_nikola_q0184_03.htm";
				case STARTED:
					if(cond == 1)
					{
						return "maestro_nikola_q0184_07.htm";
					}
					break;
				case COMPLETED:
		...
		else if(npcId == Lorain)
		{
			if(st.isStarted())
			{
				...
				{
					case 1:
						return "researcher_lorain_q0184_01.htm";
					case 2:
						return "researcher_lorain_q0184_04.htm";
					case 3:
						return "researcher_lorain_q0184_06.htm";
					case 4:
					case 5:
						return "researcher_lorain_q0184_07.htm";
				}
			}
		}
		else if(npcId == Device)
		{
			if(st.isStarted())
			{
				if(cond == 3)
				{
					...
					{
						case 0:
							return "broken_controller_q0184_01.htm";
						case 1:
							return "broken_controller_q0184_03.htm";
						case 2:
							return "broken_controller_q0184_05.htm";
						case 3:
							return "broken_controller_q0184_07.htm";
					}
				}
			}
		}
