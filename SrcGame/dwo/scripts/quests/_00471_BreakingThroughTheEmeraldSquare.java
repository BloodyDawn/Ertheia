...
public class _00471_BreakingThroughTheEmeraldSquare extends Quest
{
	// Квестовые персонажи
	...
	// Квестовые монстры
	private static final int Тюремщик = 25796;

	public _00471_BreakingThroughTheEmeraldSquare()
	{
		addStartNpc(Фиорен);
		addTalkId(Фиорен);
		addKillId(Тюремщик);
	...
	{
		new _00471_BreakingThroughTheEmeraldSquare();
	}
	...
	public void sendNpcLogList(L2PcInstance player)
	{
		...
		{
			TIntIntHashMap moblist = new TIntIntHashMap();
			moblist.put(1025796, st.getCond() - 1);
