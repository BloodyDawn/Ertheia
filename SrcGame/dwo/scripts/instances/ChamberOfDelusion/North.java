...
public class North extends Quest
{
	...
	private static final int[][] ROOM_ENTER_POINTS = {
		{-108976, -207772, -6720}, {-108976, -206972, -6720}, {-108960, -209164, -6720}, {-108048, -207340, -6720},
	...
	private int[][] MANAGER_SPAWN_POINTS = {
		{32679, -108976, -207872, -6720, 0}, {32680, -108976, -207072, -6720, 0}, {32681, -108960, -209264, -6720, 0},
		{32682, -108048, -207440, -6720, 0}, {32683, -108048, -209120, -6720, 0}

	};
	private int[][] BOX_SPAWN_POINTS = {
		{-107883, -208714, -6720, 0}, {-108208, -208893, -6720, 0}, {-108205, -209356, -6720, 0},
	...
	private void changeRoom(CDWorld world)
	{
		...
		if(world.currentRoom != ROOM_ENTER_POINTS.length && Rnd.getChance(10)) //10% chance for teleport to raid room if not here already
		{
	...
	protected int enterInstance(L2PcInstance player, String template)
	{
		...
		else
		{
			...
			world.templateId = InstanceZoneId.DELUSION_CHAMBER_NORTHERN_SEAL.getId();
			world.status = 0;
	...
	public String onAttack(L2Npc npc, L2PcInstance attacker, int damage, boolean isPet, L2Skill skill)
	{
		...
		if(tmpworld instanceof CDWorld)
		{
			...
			if(npc.getNpcId() == BOX && !world.rewardedBoxes.contains(npc.getObjectId()) && npc.getCurrentHp() < npc.getMaxHp() / 10)
			{
				...
				ItemHolder item;
				if(Rnd.getChance(25)) //25% chance to reward
				{
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		{
			enterInstance(player, "COD_North.xml");
		}
