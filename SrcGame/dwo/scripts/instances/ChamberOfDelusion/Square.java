...
public class Square extends Quest
{
	...
	private static final int[][] ROOM_ENTER_POINTS = {
		{-122368, -153388, -6688}, {-122368, -152524, -6688}, {-120480, -155116, -6688}, {-120480, -154236, -6688},
		{-121440, -151212, -6688}, {-120464, -152908, -6688}, {-122368, -154700, -6688}, {-121440, -152908, -6688},
		{-121440, -154572, -6688} //Raid room
	};
	private static final int[] AENKINEL_SPAWN = {-121555, -155000, -6688, 0};
	...
	private int[][] MANAGER_SPAWN_POINTS = {
		{32684, -122368, -153488, -6688, 0}, {32685, -122368, -152624, -6688, 0}, {32686, -120480, -155216, -6688, 0},
		{32687, -120480, -154336, -6688, 0}, {32688, -121440, -151312, -6688, 0}, {32689, -120464, -153008, -6688, 0},
		{32690, -122368, -154800, -6688, 0}, {32691, -121440, -153008, -6688, 0}, {32692, -121440, -154672, -6688, 0}

	};
	private int[][] BOX_SPAWN_POINTS = {
		{-121555, -155000, -6688, 0}, {-121261, -154896, -6688, 0}, {-121286, -154378, -6688, 0},
	...
	private boolean checkConditions(L2PcInstance player)
	{
		...
		for(L2PcInstance partyMember : party.getMembers())
		{
			...
			Long reentertime = InstanceManager.getInstance().getInstanceTime(partyMember.getObjectId(), InstanceZoneId.DELUSION_CHAMBER_GREAT_SEAL.getId());
	...
	protected int enterInstance(L2PcInstance player, String template)
	{
		...
		else
		{
			...
			world.templateId = InstanceZoneId.DELUSION_CHAMBER_GREAT_SEAL.getId();
			world.status = 0;
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		{
			enterInstance(player, "COD_Square.xml");
		}
