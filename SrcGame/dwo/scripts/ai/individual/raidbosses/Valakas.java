...
public class Valakas extends Quest
{
	...
	private static Valakas _instance;
	private int i_ai0;
	private int i_ai1;
	private int i_ai2;
	private int i_ai3;
	private int i_ai4;
	private int i_quest0;
	private long i_quest1; // time to tracking valakas when was last time attacked
	private int i_quest2; // hate value for 1st player
	private int i_quest3; // hate value for 2nd player
	private int i_quest4; // hate value for 3rd player
	private L2Character c_quest2; // 1st most hated target
	private L2Character c_quest3; // 2nd most hated target
	private L2Character c_quest4; // 3rd most hated target
	...
	public String onAttack(L2Npc npc, L2PcInstance attacker, int damage, boolean isPet, L2Skill skill)
	{
		...
		if(skill == null)
		{
			...
			else if(attacker.equals(c_quest3))
			{
			...
			else if(attacker.equals(c_quest4))
			{
		...
		else if(npc.getCurrentHp() > (npc.getMaxHp() << 1) / 4.0f)
		{
			if(attacker.equals(c_quest2))
			{
		...
		else if(attacker.equals(c_quest2))
		{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		if(npc != null)
		{
			...
			else if(event.equalsIgnoreCase("1002"))
			{
				...
				else if(npc.getCurrentHp() > npc.getMaxHp() / 4.0f)
				{
			...
			else if(event.equalsIgnoreCase("1117"))
			{
				...
				for(int i = 0; i < 20; i++)
				{
					int x = (int) (radius * Math.cos(i * 0.331)); //.331~2pi/19
					int y = (int) (radius * Math.sin(i * 0.331));
	...
	public String onAggroRangeEnter(L2Npc npc, L2PcInstance player, boolean isPet)
	{
		...
		if(GrandBossManager.getInstance().getBossStatus(VALAKAS) == FIGHTING)
		{
			...
			{
				if(player.equals(c_quest2))
				{
					if(i_quest2 < 10 * 1000 + 1000)
					{
						i_quest2 = 10 * 1000 + Rnd.get(3000);
					}
				}
				else if(player.equals(c_quest3))
				{
					if(i_quest3 < 10 * 1000 + 1000)
					{
						i_quest3 = 10 * 1000 + Rnd.get(3000);
					}
				}
				else if(player.equals(c_quest4))
				{
					if(i_quest4 < 10 * 1000 + 1000)
					{
			...
			else if(player.equals(c_quest2))
			{
				if(i_quest2 < 2 * 1000 + 1000)
				{
	...
	public void getRandomSkill(L2Npc npc)
	{
		...
		int i2 = 0;
		L2Character c2 = null;
		if(c_quest2 == null || !Util.checkIfInRange(5000, npc, c_quest2, true) || c_quest2.isDead())
		{
			i_quest2 = 0;
		}
		if(c_quest3 == null || !Util.checkIfInRange(5000, npc, c_quest3, true) || c_quest3.isDead())
		{
			i_quest3 = 0;
		}
		if(c_quest4 == null || !Util.checkIfInRange(5000, npc, c_quest4, true) || c_quest4.isDead())
		{
			i_quest4 = 0;
		}
		...
		if(i2 > 0)
		{
			...
			if(npc.getCurrentHp() > npc.getMaxHp() / 4)
			{
				...
				if(c2.getZ() < npc.getZ() + 200)
				{
					...
					else if(Rnd.getChance(15) && i0 == 1 && i_quest0 == 1)
					{
						skill = SkillTable.getInstance().getInfo(4685, 1);
						i_quest0 = 0;
					}
					else if(Rnd.getChance(10) && i1 == 1)
					{
						skill = SkillTable.getInstance().getInfo(4688, 1);
					}
					else if(Rnd.getChance(35))
					{
						skill = SkillTable.getInstance().getInfo(4683, 1);
					}
					else
					{
						skill = Rnd.getChance(33) ? SkillTable.getInstance().getInfo(4681, 1) : SkillTable.getInstance().getInfo(4682, 1);
					}
				}
				else if(Rnd.getChance(20))
				{
					skill = SkillTable.getInstance().getInfo(4690, 1);
				}
				else
				{
					skill = Rnd.getChance(15) ? SkillTable.getInstance().getInfo(4689, 1) : SkillTable.getInstance().getInfo(4684, 1);
				}
			}
			else if(npc.getCurrentHp() > (npc.getMaxHp() << 1) / 4.0f)
			{
				...
				if(c2.getZ() < npc.getZ() + 200)
				{
					...
					else if(Rnd.getChance(10) && i0 == 1 && i_quest0 == 1)
					{
						skill = SkillTable.getInstance().getInfo(4685, 1);
						i_quest0 = 0;
					}
				...
				else if(Rnd.getChance(5))
				{
					skill = SkillTable.getInstance().getInfo(4690, 1);
				}
				else
				{
					skill = Rnd.getChance(10) ? SkillTable.getInstance().getInfo(4689, 1) : SkillTable.getInstance().getInfo(4684, 1);
				}
			}
			else if(npc.getCurrentHp() > npc.getMaxHp() * 3 / 4.0)
			{
				...
				if(c2.getZ() < npc.getZ() + 200)
				{
					...
					else if(Rnd.getChance(5) && i0 == 1 && i_quest0 == 1)
					{
						skill = SkillTable.getInstance().getInfo(4685, 1);
						i_quest0 = 0;
					}
				...
				else if(Rnd.getChance(1))
				{
					skill = SkillTable.getInstance().getInfo(4690, 1);
				}
				else
				{
					skill = Rnd.getChance(5) ? SkillTable.getInstance().getInfo(4689, 1) : SkillTable.getInstance().getInfo(4684, 1);
				}
			}
			else
			{
	...
	public void broadcastSpawn(L2Npc npc)
	{
		...
		objs.stream().filter(obj -> obj instanceof L2PcInstance).forEach(obj -> {
	...
	public L2Character getRandomTarget(L2Npc npc)
	{
		...
		Collection<L2Object> objs = npc.getKnownList().getKnownObjects().values();
		result.addAll(objs.stream().filter(obj -> obj instanceof L2PcInstance || obj instanceof L2Summon || obj instanceof L2DecoyInstance).map(obj -> (L2Character) obj).collect(Collectors.toList()));
