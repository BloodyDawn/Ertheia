...
public class Gordon extends Quest
{
	...
	private static final int[][] WALKS = {
		...
		{160872, -56556, -2789}, {160857, -59072, -2613}, {160410, -59888, -2647}, {158770, -60173, -2673},
	...
	private static int _npcMoveX;
	private static int _npcMoveY;
	private static int _isWalkTo;
	private static int _npcBlock;
	private static int X;
	private static int Y;
	private static int Z;
	private static boolean _isAttacked;
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		else if(event.equalsIgnoreCase("check_ai"))
		{
			...
			if(!_isSpawned)
			{
				if (SpawnTable.getInstance().getFirstSpawn(GORDON) != null) {
                    L2Npc gordon = SpawnTable.getInstance().getFirstSpawn(GORDON).getLastSpawn();
                    if (gordon != null) {
                        _isSpawned = true;
