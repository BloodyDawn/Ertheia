...
public class Keltas extends Quest
{
	...
	private L2MonsterInstance spawnedKeltas;
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		if(event.equalsIgnoreCase("despawn"))
		{
			...
			{
				spawnedKeltas.broadcastPacket(new NS(spawnedKeltas.getObjectId(), ChatType.SHOUT, spawnedKeltas.getNpcId(), NpcStringId.THAT_IS_IT_FOR_TODAYLETS_RETREAT_EVERYONE_PULL_BACK));
				spawnedKeltas.getLocationController().delete();
	...
	public String onSpawn(L2Npc npc)
	{
		if(!npc.isTeleporting())
		{
			...
			npc.broadcastPacket(new NS(spawnedKeltas.getObjectId(), ChatType.SHOUT, spawnedKeltas.getNpcId(), NpcStringId.GUYS_SHOW_THEM_OUR_POWER));
			spawnMinions();
