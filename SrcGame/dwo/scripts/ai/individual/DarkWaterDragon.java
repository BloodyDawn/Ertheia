...
public class DarkWaterDragon extends Quest
{
	...
	private static TIntObjectHashMap<L2PcInstance> _idmap = new TIntObjectHashMap<>(); //Used to track instances of npcs
	...
	{
		L2Npc shade = addSpawn(npcId, x, y, z, 0, false, 0);
		shade.setRunning();
