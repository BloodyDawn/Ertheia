...
public class FuncHennaWindRes extends Func
{
	static final FuncHennaWindRes _fh_instance = new FuncHennaWindRes();

	private FuncHennaWindRes()
	{
		super(Stats.WIND_RES, 0x10, null);
	}
