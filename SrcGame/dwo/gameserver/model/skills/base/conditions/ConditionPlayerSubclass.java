...
public class ConditionPlayerSubclass extends Condition
{
	...
	public boolean testImpl(Env env)
	{
		...
		{
			if(((L2PcInstance) env.getCharacter()).isSubClassActive() && ((L2PcInstance) env.getCharacter()).getSubclass().isDualClass())
			{
				return true;
			}
			return ((L2PcInstance) env.getCharacter()).isSubClassActive() == _val;
		}
		return true;
	}
}