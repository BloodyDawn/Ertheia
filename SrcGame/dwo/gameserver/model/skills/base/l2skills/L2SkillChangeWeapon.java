	...
	public void useSkill(L2Character caster, L2Object[] targets)
	{
		...
		if(wpn != null)
		{
			...
			if(weaponItem.getChangeWeaponId() != 0)
			{
				...
				L2ItemInstance destroyItem = player.getInventory().destroyItem(ProcessType.CHANGEWPN, wpn, player, null);
				...
				L2ItemInstance newItem = player.getInventory().addItem(ProcessType.CHANGEWPN, newItemId, 1, player, destroyItem);
