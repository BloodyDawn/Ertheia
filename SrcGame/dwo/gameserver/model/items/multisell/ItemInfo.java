...
public class ItemInfo
{
	...
	public ItemInfo(L2ItemInstance item, boolean keepEnchant, boolean isAllowAugmentedItems, boolean isAllowElementalItems)
	{
		_enchantLevel = keepEnchant ? item.getEnchantLevel() : 0;

		_augmentId = isAllowAugmentedItems ? item.getAugmentationId() : 0;

		if(isAllowElementalItems)
		{
	...
	public int getAug1()
	{
		return 0x0000FFFF & _augmentId;
	}

	public int getAug2()
	{
		return _augmentId >> 16;
	}
