...
{
	private static Logger _log = LogManager.getLogger(L2Territory.class);
	...
	public int[] getRandomPoint()
	{
		...
		_log.log(Level.WARN, "Can't make point for territory " + _terr);
		return p;
	}
