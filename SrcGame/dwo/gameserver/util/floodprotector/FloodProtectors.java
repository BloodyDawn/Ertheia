...
public class FloodProtectors
{
	 ...
	 * Community board.
	 */
	private final FloodProtectorAction _communityBoard;

	private final FloodProtectorAction _clanSearch;
	...
	public FloodProtectors(L2GameClient client)
	{
		...
		_communityBoard = new FloodProtectorAction(client, Config.FLOOD_PROTECTOR_ITEM_AUCTION);
		_clanSearch = new FloodProtectorAction(client, Config.FLOOD_PROTECTOR_CLAN_SEARCH);
	}
	...
	public FloodProtectorAction getCommunityBoard()
	{
		return _communityBoard;
	}

	public FloodProtectorAction getClanSearch()
	{
		return _clanSearch;
	}
}
