...
public class EventData
{
	...
	public EventData(int pEventX, int pEventY, int pEventZ, int pEventReputation, int pEventpvpkills, int pEventpkkills, String pEventTitle, LinkedList<String> pKills, boolean pEventSitForced)
	{
		eventX = pEventX;
		eventY = pEventY;
		eventZ = pEventZ;
		eventReputation = pEventReputation;
