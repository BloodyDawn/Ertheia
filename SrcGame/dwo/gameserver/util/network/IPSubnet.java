...
public class IPSubnet
{
	...
	public IPSubnet(String input) throws UnknownHostException, NumberFormatException, ArrayIndexOutOfBoundsException
	{
		...
		else
		{
			...
			_mask = getMask(_addr.length << 3, _addr.length); // host, no need to check mask
			_isIPv4 = _addr.length == 4;
		}
	}
	...
	public boolean equals(Object o)
	{
		...
		{
			return applyMask(((IPSubnet) o)._addr);
		}
	...
	{
		int size = 0;
		for(byte a_mask : _mask)
		{
			size += Integer.bitCount(a_mask & 0xFF);
		}
