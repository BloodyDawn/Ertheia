...
public class ValueSortMap
{
	 ...
	 * @return LinkedHashMap Sorted new LinkedHashMap
	 */
	public static Map sortMapByValue(Map inMap, boolean ascendingOrder)
	{
	...
	private static LinkedHashMap sortMapByValue(Map inMap, Comparator comparator, Boolean ascendingOrder)
	{
		...
		List valueList = new ArrayList(values); // To get List of all values in passed Map
		Set distinctValues = new HashSet(values); // To know the distinct values in passed Map
		...
		Map hmTmpMap = new HashMap(iSize);
		Map hmNullValueMap = new HashMap();
