 ...
 * @author mkizub
 */
public class XmlDocumentSkill extends XmlDocumentBase
{

	private Skill _currentSkill;
	private List<L2Skill> _skillsInFile = new FastList<>();

	public XmlDocumentSkill(File file)
	{
		super(file);
	}
	...
	protected String getTableValue(String name)
	{
		...
		{
			_log.log(Level.ERROR, "Error in table: " + name + " of Skill Id " + _currentSkill.id, e);
			return "";
		}
	}
	...
	protected String getTableValue(String name, int idx)
	{
		...
		{
			_log.log(Level.ERROR, "wrong level count in skill Id " + _currentSkill.id + " name: " + name + " index : " + idx, e);
			return "";
		}
	}
	...
	protected void parseSkill(Node n)
	{
		...
		{
			enchantLevels1 = EnchantSkillGroupsTable.getInstance().addNewRouteForSkill(skillId, lastLvl, 1, Integer.parseInt(attrs.getNamedItem("enchantGroup1").getNodeValue()));
		}
		if(attrs.getNamedItem("enchantGroup2") != null)
		{
			enchantLevels2 = EnchantSkillGroupsTable.getInstance().addNewRouteForSkill(skillId, lastLvl, 2, Integer.parseInt(attrs.getNamedItem("enchantGroup2").getNodeValue()));
		}
		if(attrs.getNamedItem("enchantGroup3") != null)
		{
			enchantLevels3 = EnchantSkillGroupsTable.getInstance().addNewRouteForSkill(skillId, lastLvl, 3, Integer.parseInt(attrs.getNamedItem("enchantGroup3").getNodeValue()));
		}
		if(attrs.getNamedItem("enchantGroup4") != null)
		{
			enchantLevels4 = EnchantSkillGroupsTable.getInstance().addNewRouteForSkill(skillId, lastLvl, 4, Integer.parseInt(attrs.getNamedItem("enchantGroup4").getNodeValue()));
		}
		if(attrs.getNamedItem("enchantGroup5") != null)
		{
			enchantLevels5 = EnchantSkillGroupsTable.getInstance().addNewRouteForSkill(skillId, lastLvl, 5, Integer.parseInt(attrs.getNamedItem("enchantGroup5").getNodeValue()));
		}
		if(attrs.getNamedItem("enchantGroup6") != null)
		{
			enchantLevels6 = EnchantSkillGroupsTable.getInstance().addNewRouteForSkill(skillId, lastLvl, 6, Integer.parseInt(attrs.getNamedItem("enchantGroup6").getNodeValue()));
		}
		if(attrs.getNamedItem("enchantGroup7") != null)
		{
			enchantLevels7 = EnchantSkillGroupsTable.getInstance().addNewRouteForSkill(skillId, lastLvl, 7, Integer.parseInt(attrs.getNamedItem("enchantGroup7").getNodeValue()));
		}
		if(attrs.getNamedItem("enchantGroup8") != null)
		{
			enchantLevels8 = EnchantSkillGroupsTable.getInstance().addNewRouteForSkill(skillId, lastLvl, 8, Integer.parseInt(attrs.getNamedItem("enchantGroup8").getNodeValue()));
		}
		if(attrs.getNamedItem("enchantGroup9") != null)
		{
			enchantLevels9 = EnchantSkillGroupsTable.getInstance().addNewRouteForSkill(skillId, lastLvl, 9, Integer.parseInt(attrs.getNamedItem("enchantGroup9").getNodeValue()));
		}
		...
		for(int i = 0; i < lastLvl; i++)
		{
			...
			for(n = first; n != null; n = n.getNextSibling())
			{
				...
				else if("for".equalsIgnoreCase(n.getNodeName()))
				{
					...
					{
						_log.log(Level.ERROR, "Error in skill! FIX ME! " + _currentSkill.id, e);
					}
				}
			}
		}
	...
	{
		int count = 0;
		_currentSkill.currentSkills = new FastList<>(_currentSkill.sets.length + _currentSkill.enchsets1.length + _currentSkill.enchsets2.length + _currentSkill.enchsets3.length + _currentSkill.enchsets4.length + _currentSkill.enchsets5.length + _currentSkill.enchsets6.length + _currentSkill.enchsets7.length + _currentSkill.enchsets8.length + _currentSkill.enchsets9.length);
		...
		for(int i = 0; i < _currentSkill.sets.length; i++)
		{
			...
			{
				_log.log(Level.ERROR, "Skill id=" + _currentSkill.sets[i].getEnum("skillType", L2SkillType.class, L2SkillType.DUMMY).makeSkill(_currentSkill.sets[i]).getDisplayId() + "level" + _currentSkill.sets[i].getEnum("skillType", L2SkillType.class).makeSkill(_currentSkill.sets[i]).getLevel(), e);
			}
		}
		int _count = count;
		for(int i = 0; i < _currentSkill.enchsets1.length; i++)
		{
			...
			{
				_log.log(Level.ERROR, "Skill id=" + _currentSkill.enchsets1[i].getEnum("skillType", L2SkillType.class, L2SkillType.DUMMY).makeSkill(_currentSkill.enchsets1[i]).getDisplayId() + " level=" + _currentSkill.enchsets1[i].getEnum("skillType", L2SkillType.class).makeSkill(_currentSkill.enchsets1[i]).getLevel(), e);
			}
		}
		_count = count;
		for(int i = 0; i < _currentSkill.enchsets2.length; i++)
		{
			...
			{
				_log.log(Level.ERROR, "Skill id=" + _currentSkill.enchsets2[i].getEnum("skillType", L2SkillType.class, L2SkillType.DUMMY).makeSkill(_currentSkill.enchsets2[i]).getDisplayId() + " level=" + _currentSkill.enchsets2[i].getEnum("skillType", L2SkillType.class).makeSkill(_currentSkill.enchsets2[i]).getLevel(), e);
			}
		}
		_count = count;
		for(int i = 0; i < _currentSkill.enchsets3.length; i++)
		{
			...
			{
				_log.log(Level.ERROR, "Skill id=" + _currentSkill.enchsets3[i].getEnum("skillType", L2SkillType.class, L2SkillType.DUMMY).makeSkill(_currentSkill.enchsets3[i]).getDisplayId() + " level=" + _currentSkill.enchsets3[i].getEnum("skillType", L2SkillType.class).makeSkill(_currentSkill.enchsets3[i]).getLevel(), e);
			}
		}
		_count = count;
		for(int i = 0; i < _currentSkill.enchsets4.length; i++)
		{
			...
			{
				_log.log(Level.ERROR, "Skill id=" + _currentSkill.enchsets4[i].getEnum("skillType", L2SkillType.class, L2SkillType.DUMMY).makeSkill(_currentSkill.enchsets4[i]).getDisplayId() + " level=" + _currentSkill.enchsets4[i].getEnum("skillType", L2SkillType.class).makeSkill(_currentSkill.enchsets4[i]).getLevel(), e);
			}
		}
		_count = count;
		for(int i = 0; i < _currentSkill.enchsets5.length; i++)
		{
			...
			{
				_log.log(Level.ERROR, "Skill id=" + _currentSkill.enchsets5[i].getEnum("skillType", L2SkillType.class, L2SkillType.DUMMY).makeSkill(_currentSkill.enchsets5[i]).getDisplayId() + " level=" + _currentSkill.enchsets5[i].getEnum("skillType", L2SkillType.class).makeSkill(_currentSkill.enchsets5[i]).getLevel(), e);
			}
		}
		_count = count;
		for(int i = 0; i < _currentSkill.enchsets6.length; i++)
		{
			...
			{
				_log.log(Level.ERROR, "Skill id=" + _currentSkill.enchsets6[i].getEnum("skillType", L2SkillType.class, L2SkillType.DUMMY).makeSkill(_currentSkill.enchsets6[i]).getDisplayId() + " level=" + _currentSkill.enchsets6[i].getEnum("skillType", L2SkillType.class).makeSkill(_currentSkill.enchsets6[i]).getLevel(), e);
			}
		}
		_count = count;
		for(int i = 0; i < _currentSkill.enchsets7.length; i++)
		{
			...
			{
				_log.log(Level.ERROR, "Skill id=" + _currentSkill.enchsets7[i].getEnum("skillType", L2SkillType.class, L2SkillType.DUMMY).makeSkill(_currentSkill.enchsets7[i]).getDisplayId() + " level=" + _currentSkill.enchsets7[i].getEnum("skillType", L2SkillType.class).makeSkill(_currentSkill.enchsets7[i]).getLevel(), e);
			}
		}
		_count = count;
		for(int i = 0; i < _currentSkill.enchsets8.length; i++)
		{
			...
			{
				_log.log(Level.ERROR, "Skill id=" + _currentSkill.enchsets8[i].getEnum("skillType", L2SkillType.class, L2SkillType.DUMMY).makeSkill(_currentSkill.enchsets8[i]).getDisplayId() + " level=" + _currentSkill.enchsets8[i].getEnum("skillType", L2SkillType.class).makeSkill(_currentSkill.enchsets8[i]).getLevel(), e);
			}
		}
		_count = count;
		for(int i = 0; i < _currentSkill.enchsets9.length; i++)
		{
			try
			{
				_currentSkill.currentSkills.add(_count + i, _currentSkill.enchsets9[i].getEnum("skillType", L2SkillType.class, L2SkillType.DUMMY).makeSkill(_currentSkill.enchsets9[i]));
				count++;
			}
			catch(Exception e)
			{
				_log.log(Level.ERROR, "Skill id=" + _currentSkill.enchsets9[i].getEnum("skillType", L2SkillType.class, L2SkillType.DUMMY).makeSkill(_currentSkill.enchsets9[i]).getDisplayId() + " level=" + _currentSkill.enchsets9[i].getEnum("skillType", L2SkillType.class).makeSkill(_currentSkill.enchsets9[i]).getLevel(), e);
			}
		}
	}
