 ...
 * Team: La2Era Team
 * *
 * 8905	1	u,Оседлать Лиса Громовержца\0	u,Позволяет оседлать Лиса Громовержца.\0	a,none\0	a,none\0
 * *
 * 13441	u,Маг-лис Артеи\0	a,	9C	E8	A9	-1
 * *
 */
public class FoxArteasWizard extends L2Transformation
{
    private static final int[] Skills = {9210, 5491, 9206}; //todo узнать точную инфу какие скилы даются

    public FoxArteasWizard()
    {
        super(155, 12, 22);
    }
