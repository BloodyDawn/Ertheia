...
/**
 * Release attribute handler.
 *
 * @author L2J
 * @author GODWORLD
 * @author Yorie
 */
public class ReleaseAttribute extends CommandHandler<String>
{
	@TextCommand
	public boolean releaseAttribute(BypassHandlerParams params)
	{
		...
		params.getPlayer().sendPacket(new ExShowBaseAttributeCancelWindow(params.getPlayer()));
		return true;
	}
}