...
public class FlyUp extends L2Effect
{
	public FlyUp(Env env, EffectTemplate template)
	{
		super(env, template);
	}
	...
	public boolean onStart()
	{
		...
		// Мб и не верно / т.к юзается во многих местах ( в CASTTIME ) где только мешает
	...
	{
		return CharEffectList.EFFECT_FLAG_FLY_UP;
	}
}
