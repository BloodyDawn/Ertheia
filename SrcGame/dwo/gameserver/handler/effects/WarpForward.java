...
public class WarpForward extends L2Effect
{
	private int x;
	private int y;
	private int z;
	...
	public WarpForward(Env env, EffectTemplate template)
	{
		super(env, template);
	}
	...
	public boolean onStart()
	{
		...
		_actor.broadcastPacket(new FlyToLocation(_actor, x, y, z, FlyType.WARP_FORWARD, getSkill().getFlySpeed(), getSkill().getFlyDelay(), getSkill().getFlyAnimationSpeed()));
		_actor.abortAttack();
		_actor.abortCast();
