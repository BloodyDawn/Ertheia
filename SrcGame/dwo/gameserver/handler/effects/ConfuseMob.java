...
public class ConfuseMob extends L2Effect
{
	...
	public boolean onActionTime()
	{
		...
		targetList.addAll(getEffected().getKnownList().getKnownObjects().values().stream().filter(obj -> obj instanceof L2Attackable && !obj.equals(getEffected())).map(obj -> (L2Character) obj).collect(Collectors.toList()));
