...
public class AdminRide implements IAdminCommandHandler
{
	private static final String[] ADMIN_COMMANDS = {
		"admin_ride_horse", "admin_ride_bike", "admin_ride_wyvern", "admin_ride_strider", "admin_unride_wyvern",
		"admin_unride_strider", "admin_unride", "admin_ride_wolf", "admin_unride_wolf",
	};
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		{
			if(player.isMounted() || !player.getPets().isEmpty())
			{
	...
	private L2PcInstance getRideTarget(L2PcInstance activeChar)
	{
		...
		player = activeChar.getTarget() == null || activeChar.getTarget().getObjectId() == activeChar.getObjectId() || !(activeChar.getTarget() instanceof L2PcInstance) ? activeChar : (L2PcInstance) activeChar.getTarget();
