...
import dwo.gameserver.taskmanager.manager.AutoAnnounceTaskManager.AutoAnnouncement;
...
public class AdminAnnouncements implements IAdminCommandHandler
{
	...
	private static final String[] ADMIN_COMMANDS = {
		"admin_list_announcements", "admin_reload_announcements", "admin_announce_announcements",
		"admin_add_announcement", "admin_del_announcement", "admin_announce", "admin_announce_menu",
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		{
			// FIXME the player can send only 16 templates (if you try to send more
	...
	{
		String content = HtmCache.getInstance().getHtm(activeChar.getLang(), "mods/admin/autoannounce.htm");
