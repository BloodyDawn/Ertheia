...
public class TargetCorpsePartyMember implements ITargetTypeHandler
{
	@Override
	public L2Object[] getTargetList(L2Skill skill, L2Character activeChar, boolean onlyFirst, L2Character target)
	{
		...
		if(target != null && target.isDead() && target.isInParty())
		{
			L2PcInstance player;
	...
	{
		return L2TargetType.TARGET_CORPSE_PARTY_MEMBER;
	}
}