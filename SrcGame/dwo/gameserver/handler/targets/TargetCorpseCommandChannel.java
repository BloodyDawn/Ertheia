...
public class TargetCorpseCommandChannel implements ITargetTypeHandler
{
	@Override
	public L2Object[] getTargetList(L2Skill skill, L2Character activeChar, boolean onlyFirst, L2Character target)
	{
		...
		{
			L2PcInstance actor = activeChar.getActingPlayer();
			L2Party party = actor.getParty();
			if(party == null)
			{
	...
	{
		return L2TargetType.TARGET_CORPSE_COMMAND_CHANNEL;
	}
}
