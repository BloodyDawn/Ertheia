...
import dwo.gameserver.model.world.zone.type.L2FishingZone;
	...
	public void useSkill(L2Character activeChar, L2Skill skill, L2Object[] targets)
	{
		...
		if(aimingTo != null)
		{
			...
			if(Config.GEODATA_ENABLED)
			{
				...
				if(GeoEngine.getInstance().canSeeTarget(player.getX(), player.getY(), z, x, y, z, player.getInstanceId()))
				{
		...
		// follows.
		lure2 = player.getInventory().destroyItem(ProcessType.FISHING, player.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_LHAND), 1, player, null);
