...
{
	// private static Logger _log = LogManager.getLogger(BeastSkills.class);
	private static final L2SkillType[] SKILL_IDS = {
		L2SkillType.BEAST_FEED, L2SkillType.BEAST_RELEASE, L2SkillType.BEAST_RELEASE_ALL, L2SkillType.BEAST_SKILL,
	...
	public void useSkill(L2Character activeChar, L2Skill skill, L2Object[] targets)
	{
		...
		switch(type)
		{
			...
			case BEAST_RELEASE:
				...
				{
					((L2TamedBeastInstance) target).getLocationController().delete();
				}
				break;
			case BEAST_RELEASE_ALL:
				if(player.getTrainedBeasts() != null)
				{
					...
					{
						beast.getLocationController().delete();
					}
				}
				break;
