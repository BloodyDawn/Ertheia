...
public class SystemMessageId
{
	...
	/**
	 * ID: 415<br>
	 * Message: Under CastleSiegeEngine
	 */
	...
	/**
	 * ID: 493<br>
	 * Message: ThreadConnection: $s1 / Total $s2
	 */
	 ...
	 */
	public static final SystemMessageId S2_CLAN_LEADER_OF_S1_REQUESTED_ALLIANCE;
	/**
	 * ID: 530<br>
	...
	/**
	 * ID: 621<br>
	 * Message: Game ThreadConnection attempted through a restricted IP.
	 */
	...
	/**
	 * ID: 638<br>
	 * Message: You have already requested a CastleSiegeEngine Battle.
	 */
	 ...
	 * submitted a request for another CastleSiegeEngine Battle.
	 */
	 ...
	 */
	public static final SystemMessageId YOU_HAVE_BEEN_PLAYING_FOR_AN_EXTENDED_PERIOD_OF_TIME_PLEASE_CONSIDER_TAKING_A_BREAK;
	/**
	 * ID: 769<br>
	...
	/**
	 * ID: 783<br>
	 * Message: LotteryManager ticket sales have been temporarily suspended.
	 */
	...
	/**
	 * ID: 930<br>
	 * Message: LotteryManager tickets are not currently being sold.
	 */
	 ...
	 * a chat ban will be applied.
	 * This is done to discourage spamming. Please avoid posting the same
	 * message multiple times during a short period.
	 */
	...
	/**
	 * ID: 1112<br>
	 * Message: The prize amount for the winner of LotteryManager #$s1 is $s2 adena. We
	 * have $s3 first prize winners.
	 */
	public static final SystemMessageId AMOUNT_FOR_WINNER_S1_IS_S2_ADENA_WE_HAVE_S3_PRIZE_WINNER;
	/**
	 * ID: 1113<br>
	 * Message: The prize amount for Lucky LotteryManager #$s1 is $s2 adena.
	 ...
	 * alliance war, your Exp will drop
	...
	/**
	 * ID: 1270<br>
	 * Message: You have successfully switched $1 to $2
	 */
	 ...
	 * features for in-game MSN Messenger Chat.
	 ...
	 * as well.
	 * The contact can still check your online status and well not be blocked
	 ...
	 * be purchased from a village store.
	 ...
	 */
	public static final SystemMessageId RESSURECTION_REQUEST_BY_C1_FOR_S2_S3_XP;
	/**
	 * ID: 1511<br>
	 ...
	 * level five or above, and the number of clan members is fifteen or
	 * greater.
	 */
	...
	/**
	 * ID: 1574
	 * Message: No clans have declared war on you
	 */
	public static final SystemMessageId NO_DECLARED_WARS;
	/**
	 * ID: 1575<br>
	 ...
	 * or more levels higher than your Fishing skill, a 50 damage penalty will
	 * be applied.
	 */
	 ...
	 * ID: 1691<br>
	 * Message: $c1% does not meet the participation requirements.
	 * You cannot participate in the Olympiad because your inventory slot
	 * exceeds 80%.
	 */
	 ...
	 * ID: 1692<br>
	 * Message: $c1% does not meet the participation requirements.
	 * You cannot participate in the Olympiad because you have changed to your
	 * sub-class.
	 */
	...
	/**
	 * ID: 1694<br>
	 * Message: Only a clan leader that is a Noblesse can view the CastleSiegeEngine War
	 * Status window during a siege war.
	 */
	public static final SystemMessageId ONLY_NOBLESSE_LEADER_CAN_VIEW_SIEGE_STATUS_WINDOW;
	/**
	 * ID: 1695<br>
	 * Message: You can only use that during a CastleSiegeEngine War!
	 */
	...
	/**
	 * ID: 1717<br>
	 * Message: CastleSiegeEngine War Zone
	 */
	 ...
	 */
	public static final SystemMessageId S1_HAS_SENT_AN_INVITATION_TO_ROOM_S2;
	/**
	 * ID: 1902<br>
	 ...
	 * into the game
	 * for some time. You may reactivate your account by visiting the PlayNC
	 * website
	 * (http://www.plaync.com/us/support/).
	 */
	 ...
	 * character on the selected server.
	 * A restriction is in place which restricts users from creating characters
	 * on different servers where no
	 ...
	 * To unlock all of the features of Lineage II, purchase the full version
	 * today.
	 */
	 ...
	 * Ctrl and Shift
	 * will be changed to Alt + Q and Alt + E when set as expanded sub-key mode,
	 * and CTRL and SHIFT
	...
	/**
	 * ID: 2179<br>
	 * Message: You have the highest bid submitted in Giran Castle ClanHallAuctionEngine.
	 */
	public static final SystemMessageId HIGHEST_BID_FOR_GIRAN_CASTLE;
	/**
	 * ID: 2180<br>
	 * Message: You have the highest bid submitted in Aden Castle ClanHallAuctionEngine.
	 */
	public static final SystemMessageId HIGHEST_BID_FOR_ADEN_CASTLE;
	/**
	 * ID: 2181<br>
	 * Message: You have the highest bid submitted in Rune Castle ClanHallAuctionEngine.
	 */
	...
	/**
	 * ID: 2233<br>
	 * Message: CastleSiegeEngine registration is not possible due to a contract with a
	 * higher castle.
	 */
	 ...
	 * You can only use the set shortcut in the Enter Chat mode. Do you still
	 * wish to use the set shortcuts
	 */
	 ...
	 */
	public static final SystemMessageId YOU_DO_NOT_HAVE_A_SERVITOR;
	/**
	 * ID: 2319<br>
	 * Message: You have acquired $s1 reputation.
	 */
	public static final SystemMessageId YOU_HAVE_ACQUIRED_S1_REPUTATION;
	/**
	 * ID: 2314<br>
	...
	/**
	 * ID: 2492
	 * Message: The airship has been summoned. It will automatically depart in
	 * %s minutes.
	 */
	...
	/**
	 * ID: 2702
	 * Message: You were excluded from the match because the registration count
	 * was not correct.
	 */
	public static final SystemMessageId EXCLUDED_FROM_MATCH_DUE_INCORRECT_COUNT;
	/**
	 * ID: 2703
	 * Message: The team was adjusted because the population ratio was not
	 * correct.
	 */
	...
	/**
	 * ID: 2707
	 * Message: You cannot make another request for 10 seconds after cancelling
	 ...
	 */
	public static final SystemMessageId CANT_ENTER_BATTLEFIELD_IN_PARTY;
	/**
	 * ID: 2764<BR>
	 * Console Message: You cannot enter because the corresponding alliance channel's
	 * maximum number of entrants has been reached.
	 */
	public static final SystemMessageId CANNOT_ENTER_MAX_ENTRANTS;
	/**
	 * ID: 2765<BR>
	 * Console Message: Only the alliance channel leader can attempt entry.
	 */
	public static final SystemMessageId ONLY_FOR_ALLIANCE_CHANNEL_LEADER;
	/**
	 * ID: 2766<br>
	 ...
	 */
	public static final SystemMessageId CLAN_CANCELLED_PARTICIPATION_IN_S1_TERRITORY;
	/**
	 * ID: 2792<BR>
	 * Console Message: 50 clan reputation points will be awarded. Do you wish to continue?
	 */
	public static final SystemMessageId WILL_GAIN_50_REPUTATION;
	/**
	 * ID: 2793<BR>
	 * Console Message: The minimum number ($s1) of people to enter Instant Zone is not
	 * met and entry is not available.
	 */
	public static final SystemMessageId NOT_ENOUGH_PEOPLE_TO_ENTER_INSTANCE_ZONE_NEED_S1;
	/**
	 * ID: 2794<BR>
	 * Console Message: The territory war channel and functions will now be deactivated.
	 */
	public static final SystemMessageId TERRITORY_WAR_CHANNEL_FUNCTIONS_DEACTIVATED;
	/**
	 * ID: 2795<br>
	...
	/**
	 *  TODO: не хватает сообщений для эпик квеста
	 */
	/**
	 * ID: 3062<br>
	 ...
	 */
	public static final SystemMessageId YOU_CANNOT_MOVE_WHILE_SPEAKING_TO_AN_NPC;
	/**
	 * ID: 3255<br>
	...
	/**
	 * 3262	1	You can proceed only when the inventory weight is below 80 percent and the quantity is below 90 percent.	4	B09B79	ItemSound3.sys_impossible		0	0	0	0	0		popup
	 */
	public static final SystemMessageId INVENTORY_WEIGHT_80_QUANTITY_90_PERCENT;
	/**
	 * 3263	1	There are $s2 seconds remaining for $s1's re-use time. It is reset every day at 6:30 AM.	0	B09B79			0	0	0	0	0		none
	 */
	public static final SystemMessageId THERE_S2_SECOND_S1_REUSE_TIME_630;
	/**
	 * 3264	1	There are $s2 minutes $s3 seconds remaining for $s1's re-use time. It is reset every day at 6:30 AM.	0	B09B79			0	0	0	0	0		none
	 */
	public static final SystemMessageId THERE_S2_MINUTE_S3_SECOND_S1_REUSE_TIME_630;
	/**
	 * 3265	1	There are $s2 hours $s3 minutes $s4 seconds remaining for $s1's re-use time. It is reset every day at 6:30 AM.	0	B09B79			0	0	0	0	0		none
	 */
	public static final SystemMessageId THERE_S2_HOUR_S3_MINUTE_S4_SECOND_S1_REUSE_TIME_630;
	/**
	...
	/**
	 * 3365 	Cannot register item.
	 */
	public static final SystemMessageId CANNOT_REGISTER_ITEM;
	/**
	 * 3371 	Cannot buy item.
	 */
	public static final SystemMessageId CANNOT_BUY_ITEM;
	/**
	 * 3452	1	You are registered on the waiting list.
	 */
	public static final SystemMessageId YOU_ARE_REGISTERED_ON_THE_WAITING_LIST;
	/**
	 * 3453	1	Stopped searching the party.
	 */
	public static final SystemMessageId STOPPED_SEARCHING_THE_PARTY;
	/**
	 * 3465	1	Your bid for the Popular Edition Clan Hall won
	 */
	public static final SystemMessageId YOUR_BID_FOR_THE_POPULAR_EDITION_CLAN_HALL_WON;
	/**
	 * 3466	1	Your bid for the Popular Edition Clan Hall lost
	 */
	public static final SystemMessageId YOUR_BID_FOR_THE_POPULAR_EDITION_CLAN_HALL_LOST;
	/**
	 * 3467	1	Clan Level requirements for bidding are not met.
	 */
	public static final SystemMessageId CLAN_LEVEL_REQUIREMENTS_FOR_BIDDING_ARE_NOT_MET;
	/**
	 * 3477 You cannot register, buy or cancel item commission during trade.
	 */
	public static final SystemMessageId COMMISSION_CANNOT_REGISTER_BUY_OR_CANCEL_DURING_TRADE;
	/**
	 * 3478 You cannot register, buy or cancel item commission during private store or crafting mode.
	 */
	public static final SystemMessageId COMMISSION_CANNOT_REGISTER_BUY_OR_CANCEL_DURING_PRIVATE_STORE_OR_CRAFTING_MODE;
	/**
	 * 3479 You cannot register, buy or cancel item commission during enchanting, enhancing or crystallizing.
	 */
	public static final SystemMessageId COMMISSION_CANNOT_REGISTER_BUY_OR_CANCEL_DURING_ENCHANTING_ENHANCING_OR_CRYSTALLIZING;
	/**
	 * 3480 You cannot register items, that are cannot be traded, dropped or selled in private store, also augmented and temporal items.
	 */
	public static final SystemMessageId COMMISSION_CANNOT_REGISTER_ITEMS_THAT_ARE_CANNOT_BE_TRADED_DROPPED_OR_SELLED_IN_PRIVATE_STORE;
	/**
	 * 3481 For item buying you need 20 percents weight limit and 10 percents count limit.
	 */
	public static final SystemMessageId COMMISSION_FOR_ITEM_BUYING_YOU_NEED_20_PERCENTS_WEIGHT_LIMIT_AND_10_PERCENTS_COUNT_LIMIT;
	/**
	 * 3482 Price limit.
	 */
	public static final SystemMessageId COMMISSION_PRICE_LIMIT;
	/**
	 * 3483 Count limit.
	 */
	public static final SystemMessageId COMMISSION_COUNT_LIMIT;
	/**
	 * 3484	1	The item has been successfully registered.
	 */
	public static final SystemMessageId THE_ITEM_HAS_BEEN_SUCCESSFULLY_REGISTERED;
	/**
	 * 3485	1	Cancellation of Sale for the item is successful..
	 */
	public static final SystemMessageId CANCELLATION_OF_SALE_FOR_THE_ITEM_IS_SUCCESSFUL;
	/**
	 * 3490 Registered item was sold.
	 */
	public static final SystemMessageId COMMISSION_REGISTERED_ITEM_WAS_SOLD;
	/**
	 * 3491 S1 - sold.
	 */
	public static final SystemMessageId COMMISSION_S1_SOLD;
	/**
	 * 3492 Registration period expired.
	 */
	public static final SystemMessageId COMMISSION_REGISTRATION_PERIOD_EXPIRED;
	/**
	 * 3493 Registration period expired. Item is returned.
	 */
	public static final SystemMessageId COMMISSION_REGISTRATION_PERIOD_EXPIRED_ITEM_IS_RETURNED;
	/**
	 * 3494 Cannot registered wearing item.
	 */
	public static final SystemMessageId COMMISSION_CANNOT_REGISTER_WEARING_ITEM;
	/**
	 * 3566 Cannot registered wearing item.
	 */
	public static final SystemMessageId MAGMELD_NEAR_ANCIENT_CITY_ARCAN_S1_S2_S3;
	/**
	 * 3567 Cannot registered wearing item.
	 */
	public static final SystemMessageId GARDEN_OF_LIFE_NEAR_ANCIENT_CITY_ARCAN_S1_S2_S3;
	/**
	 * 3574	1	You cannot change the class because of identity crisis.
	 */
	public static final SystemMessageId YOU_CANNOT_CHANGE_CLASS_BECAUSE_OF_IDENTIFY_CRISIS;
	/**
	 * 3615	You have acquired $s1 Fame
	 */
	public static final SystemMessageId YOU_HAVE_ACQUIRED_S1_FAME;
	/**
	 * 3644	Registration will be cancelled while using the instance zone
	 */
	public static final SystemMessageId REGISTRATION_WILL_BE_CANCELLED_WHILE_USING_THE_INSTANCE_ZONE;
	/**
	 * 3659	You cannot change an attribute while using a private shop or workshop.
	 */
	 ...
	 */
	public static final SystemMessageId ENCHANTMENT_OR_ATTRIBUTE_ENCHANTMENT_IS_IN_PROGRESS;
	/**
	 ...
	 */
	public static final SystemMessageId YOU_CANNOT_CHANGE_ATTRIBUTES_WHILE_EXCHANGING;
	/**
    ...
    public static final SystemMessageId YOU_CANNOT_DO_THAT_WHILE_IN_A_PRIVATE_STORE_OR_PRIVATE_WORKSHOP;

    public static final SystemMessageId YOU_CANNOT_USE_THIS_SYSTEM_DURING_TRADING_PRIVATE_STORE_AND_WORKSHOP_SETUP;
    /**
     * ID: 3713
	...
	public static final SystemMessageId THE_OBJECT_S1_PROPERTY_S2_SUCCESSFULLY_REPLACED_WITH_S3;
	/**
	 * ID: 6505<br>
    ...
    public static final SystemMessageId ABILITIES_CAN_BE_USED_BY_NOBLESSE_EXALTED_LV_99_OR_ABOVE;

    public static final SystemMessageId YOU_CANNOT_ACQUIRE_ANY_MORE_ABILITY_POINTS;

    public static final SystemMessageId YOU_NEED_S1_SP_TO_CONVERT_TO1_ABILITY_POINT;

    public static final SystemMessageId YOU_CANNOT_USE_ALCHEMY_DURING_BATTLE;
    public static final SystemMessageId YOU_CANNOT_USE_ALCHEMY_WHILE_TRADING_OR_USING_A_PRIVATE_STORE_OR_SHOP;
    public static final SystemMessageId YOU_CANNOT_USE_ALCHEMY_WHILE_DEAD;
    public static final SystemMessageId YOU_CANNOT_USE_ALCHEMY_WHILE_IMMOBILE;


    private static final Logger _log = LogManager.getLogger(SystemMessageId.class);
    /**
	...
	static
	{
		...
		S2_CLAN_LEADER_OF_S1_REQUESTED_ALLIANCE = new SystemMessageId(527);
        ...
        YOU_HAVE_BEEN_PLAYING_FOR_AN_EXTENDED_PERIOD_OF_TIME_PLEASE_CONSIDER_TAKING_A_BREAK = new SystemMessageId(764);
		...
		RESSURECTION_REQUEST_BY_C1_FOR_S2_S3_XP = new SystemMessageId(1510);
		...
		NO_DECLARED_WARS = new SystemMessageId(1574);
		...
		S1_HAS_SENT_AN_INVITATION_TO_ROOM_S2 = new SystemMessageId(1901);
		...
		YOU_DO_NOT_HAVE_A_SERVITOR = new SystemMessageId(2311);
		YOU_HAVE_ACQUIRED_S1_REPUTATION = new SystemMessageId(2319);
		...
		CANT_ENTER_BATTLEFIELD_IN_PARTY = new SystemMessageId(2763);
		CANNOT_ENTER_MAX_ENTRANTS = new SystemMessageId(2764);
		ONLY_FOR_ALLIANCE_CHANNEL_LEADER = new SystemMessageId(2765);
		...
		CLAN_CANCELLED_PARTICIPATION_IN_S1_TERRITORY = new SystemMessageId(2791);
		WILL_GAIN_50_REPUTATION = new SystemMessageId(2792);
		NOT_ENOUGH_PEOPLE_TO_ENTER_INSTANCE_ZONE_NEED_S1 = new SystemMessageId(2793);
		TERRITORY_WAR_CHANNEL_FUNCTIONS_DEACTIVATED = new SystemMessageId(2794);
		...
		YOU_CANNOT_MOVE_WHILE_SPEAKING_TO_AN_NPC = new SystemMessageId(3226);
		...
		INVENTORY_WEIGHT_80_QUANTITY_90_PERCENT = new SystemMessageId(3262);
		THERE_S2_SECOND_S1_REUSE_TIME_630 = new SystemMessageId(3263);
		THERE_S2_MINUTE_S3_SECOND_S1_REUSE_TIME_630 = new SystemMessageId(3264);
		THERE_S2_HOUR_S3_MINUTE_S4_SECOND_S1_REUSE_TIME_630 = new SystemMessageId(3265);
		...
		CANNOT_BUY_ITEM = new SystemMessageId(3371);
		CANNOT_REGISTER_ITEM = new SystemMessageId(3365);
		YOU_ARE_REGISTERED_ON_THE_WAITING_LIST = new SystemMessageId(3452);
		STOPPED_SEARCHING_THE_PARTY = new SystemMessageId(3453);
		YOUR_BID_FOR_THE_POPULAR_EDITION_CLAN_HALL_WON = new SystemMessageId(3465);
		YOUR_BID_FOR_THE_POPULAR_EDITION_CLAN_HALL_LOST = new SystemMessageId(3466);
		CLAN_LEVEL_REQUIREMENTS_FOR_BIDDING_ARE_NOT_MET = new SystemMessageId(3467);
		COMMISSION_CANNOT_REGISTER_BUY_OR_CANCEL_DURING_TRADE = new SystemMessageId(3477);
		COMMISSION_CANNOT_REGISTER_BUY_OR_CANCEL_DURING_PRIVATE_STORE_OR_CRAFTING_MODE = new SystemMessageId(3478);
		COMMISSION_CANNOT_REGISTER_BUY_OR_CANCEL_DURING_ENCHANTING_ENHANCING_OR_CRYSTALLIZING = new SystemMessageId(3479);
		COMMISSION_CANNOT_REGISTER_ITEMS_THAT_ARE_CANNOT_BE_TRADED_DROPPED_OR_SELLED_IN_PRIVATE_STORE = new SystemMessageId(3480);
		COMMISSION_FOR_ITEM_BUYING_YOU_NEED_20_PERCENTS_WEIGHT_LIMIT_AND_10_PERCENTS_COUNT_LIMIT = new SystemMessageId(3481);
		COMMISSION_PRICE_LIMIT = new SystemMessageId(3482);
		COMMISSION_COUNT_LIMIT = new SystemMessageId(3483);
		...
		COMMISSION_REGISTERED_ITEM_WAS_SOLD = new SystemMessageId(3490);
		COMMISSION_S1_SOLD = new SystemMessageId(3491);
		COMMISSION_REGISTRATION_PERIOD_EXPIRED = new SystemMessageId(3492);
		COMMISSION_REGISTRATION_PERIOD_EXPIRED_ITEM_IS_RETURNED = new SystemMessageId(3493);
		COMMISSION_CANNOT_REGISTER_WEARING_ITEM = new SystemMessageId(3494);
		MAGMELD_NEAR_ANCIENT_CITY_ARCAN_S1_S2_S3 = new SystemMessageId(3566);
		GARDEN_OF_LIFE_NEAR_ANCIENT_CITY_ARCAN_S1_S2_S3 = new SystemMessageId(3567);
		YOU_CANNOT_CHANGE_CLASS_BECAUSE_OF_IDENTIFY_CRISIS = new SystemMessageId(3574);
		YOU_HAVE_ACQUIRED_S1_FAME = new SystemMessageId(3615);
		REGISTRATION_WILL_BE_CANCELLED_WHILE_USING_THE_INSTANCE_ZONE = new SystemMessageId(3644);
		YOU_CANNOT_CHANGE_AN_ATTRIBUTE_WHILE_USING_A_PRIVATE_SHOP_OR_WORKSHOP = new SystemMessageId(3659);
		ENCHANTMENT_OR_ATTRIBUTE_ENCHANTMENT_IS_IN_PROGRESS = new SystemMessageId(3660);
		CHANGING_ATTRIBUTES_HAS_BEEN_FAILED = new SystemMessageId(3661);
		YOU_CANNOT_CHANGE_ATTRIBUTES_WHILE_EXCHANGING = new SystemMessageId(3662);
		...
		THE_OBJECT_S1_PROPERTY_S2_SUCCESSFULLY_REPLACED_WITH_S3 = new SystemMessageId(3668);

        ABILITIES_CAN_BE_USED_BY_NOBLESSE_EXALTED_LV_99_OR_ABOVE = new SystemMessageId(4195);
        YOU_CANNOT_ACQUIRE_ANY_MORE_ABILITY_POINTS = new SystemMessageId(4185);
        YOU_NEED_S1_SP_TO_CONVERT_TO1_ABILITY_POINT = new SystemMessageId(4186);

        YOU_CANNOT_DO_THAT_WHILE_IN_A_PRIVATE_STORE_OR_PRIVATE_WORKSHOP = new SystemMessageId(4217);

        YOU_CANNOT_USE_THIS_SYSTEM_DURING_TRADING_PRIVATE_STORE_AND_WORKSHOP_SETUP = new SystemMessageId(6083);

        YOU_CANNOT_USE_ALCHEMY_DURING_BATTLE = new SystemMessageId(4270);
        YOU_CANNOT_USE_ALCHEMY_WHILE_TRADING_OR_USING_A_PRIVATE_STORE_OR_SHOP = new SystemMessageId(4280);
        YOU_CANNOT_USE_ALCHEMY_WHILE_DEAD = new SystemMessageId(4281);
        YOU_CANNOT_USE_ALCHEMY_WHILE_IMMOBILE = new SystemMessageId(4282);
	...
	private static void buildFastLookupTable()
	{
		...
		List<SystemMessageId> smIds = new ArrayList<>(fields.length);
		...
		for(Field field : fields)
		{
			...
			if(Modifier.isStatic(mod) && Modifier.isPublic(mod) && Modifier.isFinal(mod) && field.getType().equals(SystemMessageId.class))
			{
				try
				{
					...
					smId._name = field.getName();
					smId.setParamCount(parseMessageParameters(field.getName()));
					maxId = Math.max(maxId, smId._id);
					smIds.add(smId);
				}
				catch(Exception e)
				{
					_log.log(Level.ERROR, "SystemMessageId: Failed field access for '" + field.getName() + '\'', e);
				}
			}
		}
