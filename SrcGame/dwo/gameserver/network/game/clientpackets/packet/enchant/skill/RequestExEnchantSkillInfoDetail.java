 ...
 *
 */
public class RequestExEnchantSkillInfoDetail extends L2GameClientPacket
{
	private int _type;
	...
	protected void runImpl()
	{
		...
		{
			L2EnchantSkillLearn esl = EnchantSkillGroupsTable.getInstance().getSkillEnchantmentBySkillId(_skillId);
			if(esl != null)
			{
