...
import dwo.gameserver.network.game.serverpackets.packet.variation.ExVariationCancelResult;
	...
	protected void runImpl()
	{
		...
		switch(targetItem.getItem().getCrystalType())
		{
			case C:
				...
				{
					price = targetItem.getCrystalCount() < 2452 ? 150000 : 210000;
				}
				break;
			case B:
				price = targetItem.getCrystalCount() < 1746 ? 240000 : 270000;
				break;
			case A:
				...
				{
					price = targetItem.getCrystalCount() < 2824 ? 390000 : 420000;
				}
				break;
			case S:
				price = 480000;
		...
		// Lindvior: Снятие аугментации больше не требует оплаты
		/*if (!activeChar.reduceAdena(ProcessType.REFINE, price, null, true))
		{
			activeChar.sendPacket(new ExVariationCancelResult(0));
