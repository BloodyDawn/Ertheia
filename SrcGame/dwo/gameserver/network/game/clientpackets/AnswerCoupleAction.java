...
public class AnswerCoupleAction extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		L2PcInstance target = WorldManager.getInstance().getPlayer(_charObjId);
		...
		{
			target.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.C1_IS_SET_TO_REFUSE_COUPLE_ACTIONS).addPcName(activeChar));
		}
