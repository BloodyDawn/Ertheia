...
import dwo.gameserver.model.player.macro.L2Macro.L2MacroCmd;
...
public class RequestMakeMacro extends L2GameClientPacket
{
	...
	protected void readImpl()
	{
		...
		if(Config.DEBUG)
		{
			_log.log(Level.DEBUG, "Make macro id:" + _id + "\tname:" + _name + "\tdesc:" + _desc + "\tacronym:" + _acronym + "\ticon:" + _icon + "\tcount:" + _count);
		}
		...
		for(int i = 0; i < _count; i++)
		{
			...
			if(Config.DEBUG)
			{
				_log.log(Level.DEBUG, "entry:" + entry + "\ttype:" + type + "\td1:" + d1 + "\td2:" + d2 + "\tcommand:" + command);
			}
		}
