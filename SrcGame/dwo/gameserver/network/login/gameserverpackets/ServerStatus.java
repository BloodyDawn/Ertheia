...
{
	public static final String[] STATUS_STRING = {"Auto", "Good", "Normal", "Full", "Down", "Gm Only", "World", "New", "Classic"};
	...
	public static final int SERVER_WORLD_RAID = 0x100;
	public static final int SERVER_NEW = 0x200;
    public static final int SERVER_CLASSIC = 0x400;
	// Server Ages
