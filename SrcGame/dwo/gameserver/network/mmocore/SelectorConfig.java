...
{
	public int READ_BUFFER_SIZE = 64 << 10;

	public int WRITE_BUFFER_SIZE = 64 << 10;

	public int HELPER_BUFFER_COUNT = 20;

	public int HELPER_BUFFER_SIZE = 64 << 10;

	/**
	 * ServerMode will try to send MAX_SEND_PER_PASS packets per socket write call<br>
	...
	/**
	 * ServerMode will try to read MAX_READ_PER_PASS packets per socket read call<br>
