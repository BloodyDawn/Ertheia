 ...
 * <li>A general ThreadPool where everything else that needs to run asynchronously with no delay should be executed ({@link dwo.gameserver.model.actor.knownlist KnownList} updates, SQL updates/inserts...)?</li>
 * </ul>
 * </p>
 *
 * @author -Wooden-
...
{
	protected static final Logger _log = LogManager.getLogger(ThreadPoolManager.class);
	/**
	...
	public String[] getStats()
	{
		return new String[]{
			...
			"TP:", " + Packets:", " |- ActiveThreads:   " + _generalPacketsThreadPool.getActiveCount(),
			...
			" |- QueuedTasks:     " + _generalThreadPool.getQueue().size(), " | -------", " + Javolution stats:",
			" |- FastList:        " + FastList.report(), " |- FastMap:        " + FastMap.report(),
	...
	public void shutdown()
	{
		...
		try
		{
			...
			_log.log(Level.INFO, "All ThreadPools are now stopped");
