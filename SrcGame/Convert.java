...
public class Convert {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Document document = dBuilder.parse(new File("E:\\java-projects\\L2WT_Lindvior\\Data\\game\\data\\stats\\skills\\base\\data.xml"));
        ...
        for (Map.Entry<Integer, Document> docs : map.entrySet()) {
            ...
            StreamResult result = new StreamResult(new File("E:\\java-projects\\L2WT_Lindvior\\Data\\game\\data\\stats\\skills\\base", name));
