...
import dwo.loginserver.LoginController.AuthLoginResult;
import dwo.loginserver.network.loginclientcon.serverpackets.AccountKicked;
import dwo.loginserver.network.loginclientcon.serverpackets.AccountKicked.AccountKickedReason;
...
{
	private static Logger _log = LogManager.getLogger(RequestAuthLogin.class);
