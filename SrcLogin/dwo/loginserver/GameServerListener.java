...
{
	private static Logger _log = LogManager.getLogger(GameServerListener.class);
	...
	public void addClient(Socket s)
	{
		if(Config.DEBUG)
		{
			_log.log(Level.DEBUG, "Received gameserver connection from: " + s.getInetAddress().getHostAddress());
		}
