CREATE TABLE IF NOT EXISTS `characters` (
  ...
  `custom_face` INT UNSIGNED NOT NULL DEFAULT 0,
  `custom_hair_style` INT UNSIGNED NOT NULL DEFAULT 0,
  `custom_hair_color` INT UNSIGNED NOT NULL DEFAULT 0,
  ...
  `name_color` MEDIUMINT UNSIGNED NOT NULL DEFAULT '16777079',
  ...
  `pcbang_points` int(11) default '0',
  PRIMARY KEY (`charId`),
